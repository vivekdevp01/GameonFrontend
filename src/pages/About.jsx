  ...
  return (
    <>
      ...
      <div data-testid="about-page">
        {/* HERO */}
        <section
          className="relative min-h-[42vh] sm:min-h-[50vh] md:min-h-[70vh] flex items-center md:items-end overflow-hidden goi-noise"
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 pb-8 sm:pb-12 md:pb-16 pt-6 sm:pt-24 md:pt-32 w-full">
            ...
            <h1 className="font-display font-black uppercase text-5xl sm:text-6xl lg:text-7xl leading-[0.95] tracking-tighter max-w-4xl">
              Play. Eat. <span className="goi-text-cycle">Celebrate.</span>
            </h1>
          </div>
        </section>
        {/* STORY */}
        <section
          className="py-9 sm:py-14 md:py-32 px-6 md:px-10 max-w-7xl mx-auto"
