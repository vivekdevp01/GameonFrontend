...
export default function Blog() {
  ...
  return (
    <>
      <SEO
        title="Game On India Blog | Arcade, VR, Bowling & Birthday Party Guides"
        description="Read the latest Game On India blogs featuring birthday party ideas, arcade game guides, VR experiences, bowling tips and family entertainment across Jalandhar, Amritsar, Zirakpur and Pune."
        path="/blog"
        keywords="Game On India blog, arcade blog, VR games, bowling, birthday party ideas, family entertainment"
      />
        ...
        <section className="relative pt-40 pb-16 px-6 md:px-10 goi-noise overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <p className="text-white/60 max-w-2xl">
              Party ideas, game guides, and behind-the-scenes from every Game On
              India branch.
            </p>
          </div>
        </section>
