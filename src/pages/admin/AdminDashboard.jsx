...
// // // //           onClick={() => setEditing("new")}
// // // //           data-testid={`admin-add-${collectionKey}-btn`}
// // // //           className="goi-btn-primary text-xs sm:text-sm !px-3 sm:!px-5 !py-2 sm:!py-2.5"
// // // //         >
// // // //           <Plus className="w-4 h-4" /> Add new
// // // //         </button>
// // // //       </div>
...
// // // //       {editing && (
// // // //         <div
// // // //           className="goi-card rounded-2xl p-4 sm:p-6 mb-6"
// // // //           data-testid="admin-editor"
// // // //         >
// // // //           <div className="font-display font-bold text-lg sm:text-xl mb-4">
// // // //             {editing === "new" ? "Add new" : "Edit"}
// // // //           </div>
// // // //           <ItemForm
// // // //             schema={schema}
...
// // // //             <div
// // // //               key={it.id}
// // // //               className="goi-card rounded-xl p-3 sm:p-4 flex items-center justify-between gap-3 sm:gap-4"
// // // //               data-testid={`admin-row-${collectionKey}-${it.id}`}
// // // //             >
// // // //               <div className="flex-1 min-w-0">
...
// // // //                   {displayField(it)}
// // // //                   {collectionKey === "blog_posts" && !it.published && (
// // // //                     <span className="shrink-0 text-[9px] px-2 py-0.5 rounded-full bg-yellow-500/20 text-yellow-300 border border-yellow-500/30 uppercase tracking-widest font-bold">
// // // //                       Draft
// // // //                     </span>
// // // //                   )}
// // // //                 </div>
...
// // // //                   onClick={() => setEditing(it)}
// // // //                   data-testid={`admin-edit-${it.id}`}
// // // //                   className="p-1.5 sm:p-2 rounded-lg border border-white/10 hover:border-brand-cyan hover:text-brand-cyan"
// // // //                 >
...
// // // //                   onClick={() => del(it)}
// // // //                   data-testid={`admin-delete-${it.id}`}
// // // //                   className="p-1.5 sm:p-2 rounded-lg border border-white/10 hover:border-red-400 hover:text-red-400"
// // // //                 >
...
// // // //     );
// // // //   return (
// // // //     <div className="goi-card rounded-2xl p-4 sm:p-6">
// // // //       <ItemForm
// // // //         schema={SCHEMAS.contact_info}
// // // //         initial={data}
// // // //         onSave={save}
...
// // // //               onClick={() => setKind(t.k)}
// // // //               data-testid={`admin-sub-tab-${t.k}`}
// // // //               className={`shrink-0 whitespace-nowrap px-3.5 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium border ${kind === t.k ? "bg-brand-magenta border-brand-magenta" : "border-white/10 text-white/70"}`}
// // // //             >
// // // //               {t.l}
// // // //             </button>
// // // //           ))}
...
// // // //           <button
// // // //             onClick={() => setStatusFilter("all")}
// // // //             className={`shrink-0 whitespace-nowrap px-3 py-1.5 rounded-full text-xs font-semibold border ${statusFilter === "all" ? "bg-white/15 border-white/30" : "border-white/10 text-white/60"}`}
// // // //           >
// // // //             All ({items.length})
// // // //           </button>
// // // //           {STATUS_OPTIONS.map((s) => (
...
// // // //               key={s}
// // // //               onClick={() => setStatusFilter(s)}
// // // //               className={`shrink-0 whitespace-nowrap px-3 py-1.5 rounded-full text-xs font-semibold border capitalize ${
// // // //                 statusFilter === s
// // // //                   ? STATUS_STYLES[s]
// // // //                   : "border-white/10 text-white/60"
// // // //               }`}
...
// // // //                 <button
// // // //                   onClick={() => toggle(id)}
// // // //                   className="w-full flex justify-between items-center gap-3 sm:gap-4 p-3.5 sm:p-5 text-left"
// // // //                 >
// // // //                   <div className="min-w-0">
// // // //                     <h3 className="text-sm sm:text-lg font-bold truncate">
// // // //                       {displayName}
// // // //                     </h3>
// // // //                     <div className="flex flex-wrap gap-2 sm:gap-3 mt-1 text-[11px] sm:text-xs text-white/60">
// // // //                       {s.email && (
...
// // // //                     <span
// // // //                       className={`px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-bold border ${STATUS_STYLES[status] || STATUS_STYLES.pending}`}
// // // //                     >
// // // //                       {status.toUpperCase()}
// // // //                     </span>
...
// // // //                 {isOpen && (
// // // //                   <div className="px-3.5 sm:px-5 pb-4 sm:pb-5 border-t border-white/10 pt-4">
...
// // // //                               <div
// // // //                                 key={f.k}
// // // //                                 className="goi-card p-3 sm:p-4 rounded-xl bg-white/5"
// // // //                               >
// // // //                                 <div className="text-xs text-white/50 uppercase">
// // // //                                   {f.label}
// // // //                                 </div>
...
// // // //                           {longtext.label}
// // // //                         </div>
// // // //                         <div className="bg-white/5 rounded-xl p-3 sm:p-4 text-sm sm:text-base text-white/80">
// // // //                           {s[longtext.k]}
// // // //                         </div>
// // // //                       </div>
// // // //                     )}
...
// // // //                         <a
// // // //                           href={`mailto:${s.email}`}
// // // //                           className="goi-btn-outline text-xs sm:text-sm"
// // // //                         >
...
// // // //                             target="_blank"
// // // //                             rel="noreferrer"
// // // //                             className="goi-btn-primary text-xs sm:text-sm"
// // // //                           >
// // // //                             WhatsApp
// // // //                           </a>
// // // //                         </>
...
// // // //             />
// // // //             <div className="min-w-0">
// // // //               <div className="text-[9px] sm:text-[10px] tracking-widest uppercase text-brand-cyan font-bold">
// // // //                 Admin
// // // //               </div>
// // // //               <div className="font-display font-bold text-xs sm:text-sm leading-none truncate">
// // // //                 Dashboard
// // // //               </div>
// // // //             </div>
// // // //           </div>
...
// // // //               onClick={logout}
// // // //               data-testid="admin-logout-btn"
// // // //               className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg border border-white/10 hover:border-brand-magenta hover:text-brand-magenta"
// // // //             >
...
// // // //         >
// // // //           <div
// // // //             className="absolute inset-0 bg-black/70 backdrop-blur-sm animate-[fadeUp_0.2s_ease]"
// // // //             onClick={() => setMobileMenuOpen(false)}
// // // //           />
// // // //           <div className="absolute left-0 top-0 bottom-0 w-[78%] max-w-xs bg-brand-surface border-r border-white/10 flex flex-col animate-[fadeUp_0.25s_ease]">
...
// // // //                   data-testid={`admin-tab-mobile-${t.key}`}
// // // //                   className={`w-full flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium mb-1 text-left ${
// // // //                     tab === t.key
...
// // // //       <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-8 py-5 sm:py-8 grid md:grid-cols-[220px_1fr] gap-5 md:gap-8">
...
// // // //                 onClick={() => setTab(t.key)}
// // // //                 data-testid={`admin-tab-${t.key}`}
// // // //                 className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium mb-1 text-left ${
// // // //                   tab === t.key
// // // //                     ? "bg-brand-magenta/15 text-brand-magenta"
// // // //                     : "text-white/70 hover:bg-white/5"
// // // //                 }`}
...
// // // //             <div className="goi-overline mb-2 text-[10px] sm:text-xs">
// // // //               Manage
// // // //             </div>
// // // //             <h1 className="font-display font-black text-xl sm:text-2xl md:text-3xl">
// // // //               {activeTab?.label}
// // // //             </h1>
// // // //           </div>
// // // //           {tab === "contact_info" ? (
...
// // //     { k: "parking", label: "Parking info", type: "text" },
// // //     { k: "facilities", label: "Facilities (comma separated)", type: "csv" },
// // //     { k: "hero_image", label: "Hero image", type: "image" },
// // //     {
// // //       k: "gallery",
// // //       label: "Gallery image URLs (comma separated)",
// // //       type: "csv",
...
// // //   if (schema.type === "number") return value == null ? "" : String(value);
// // //   if (schema.type === "boolean") return !!value;
// // //   if (schema.type === "image") return value || "";
// // //   return value == null ? "" : value;
// // // }
// // // function valueFromField(schema, raw) {
// // //   if (schema.type === "csv")
...
// // //   if (schema.type === "number") return raw === "" ? null : Number(raw);
// // //   if (schema.type === "boolean") return !!raw;
// // //   if (schema.type === "image") return raw || "";
// // //   return raw;
// // // }
...
// // //             <ImageUploadField
// // //               value={fieldFromValue(s, getNested(data, s.k))}
// // //               onChange={(url) => set(s.k, valueFromField(s, url))}
// // //               label={s.label}
// // //             />
// // //           ) : (
// // //             <input
...
// //   if (schema.type === "boolean") return !!value;
// //   if (schema.type === "image") return value || "";
// //   if (schema.type === "images") return Array.isArray(value) ? value : [];
// //   return value == null ? "" : value;
// // }
// // function valueFromField(schema, raw) {
// //   if (schema.type === "csv")
...
// //   if (schema.type === "boolean") return !!raw;
// //   if (schema.type === "image") return raw || "";
// //   if (schema.type === "images") return Array.isArray(raw) ? raw : [];
// //   return raw;
// // }
...
// //               value={fieldFromValue(s, getNested(data, s.k))}
// //               onChange={(urls) => set(s.k, valueFromField(s, urls))}
// //               label={s.label}
// //             />
// //           ) : (
// //             <input
...
//     {
//       k: "gallery",
//       label: "Gallery images (with category per photo)",
//       type: "gallery",
//     },
//   ],
//   card_offers: [
...
//   ],
//   gallery_images: [
//     { k: "url", label: "Photo", type: "image" },
//     {
//       k: "category",
//       label:
//         "Category (Birthday Parties / School Visits / Corporate Events / Game Zone)",
//       type: "text",
//     },
//     {
//       k: "branch_slug",
//       label: "Branch slug (optional — leave blank if not branch-specific)",
//       type: "text",
//     },
//     { k: "caption", label: "Caption (optional)", type: "text" },
//   ],
//   contact_info: [
//     { k: "hq_address", label: "HQ Address", type: "textarea" },
//     { k: "hq_phone", label: "HQ Phone", type: "text" },
...
//   if (schema.type === "image") return value || "";
//   if (schema.type === "images") return Array.isArray(value) ? value : [];
//   if (schema.type === "gallery") return Array.isArray(value) ? value : [];
//   return value == null ? "" : value;
// }
// function valueFromField(schema, raw) {
//   if (schema.type === "csv")
...
//   if (schema.type === "image") return raw || "";
//   if (schema.type === "images") return Array.isArray(raw) ? raw : [];
//   if (schema.type === "gallery") return Array.isArray(raw) ? raw : [];
//   return raw;
// }
...
//             <GalleryUploadField
//               value={fieldFromValue(s, getNested(data, s.k))}
//               onChange={(imgs) => set(s.k, valueFromField(s, imgs))}
//               label={s.label}
//             />
//           ) : (
//             <input
...
//     it.city ||
//     it.caption ||
//     (it.category ? `${it.category} photo` : null) ||
//     `Card ₹${it.card_value} → ${it.points}pts (${it.branch_slug})` ||
//     it.id;
...
//               data-testid={`admin-row-${collectionKey}-${it.id}`}
//             >
//               {(it.url || it.image || it.hero_image) && (
//                 <img
//                   src={it.url || it.image || it.hero_image}
//                   alt=""
...
import MultiImageUploadField from "@/components/MultiImageUploadField";
import GalleryUploadField from "@/components/GalleryUploadField";
import GalleryBulkUploadForm from "@/components/GalleryBulkUploadForm";
        ...
        {collectionKey === "gallery_images" ? (
          <div className="flex gap-2">
            <button
              ...
              data-testid={`admin-add-${collectionKey}-btn`}
              className="goi-btn-outline text-xs sm:text-sm !px-3 sm:!px-5 !py-2 sm:!py-2.5"
            >
