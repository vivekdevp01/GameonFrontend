...
//                 <div className="font-semibold truncate">{displayField(it)}</div>
...
// //           )}
// //           {items.map((s, i) => (
// //             // <details key={s.id || i} className="goi-card rounded-xl">
// //             //     <summary className="cursor-pointer p-4 flex items-center justify-between">
// //             //         <div>
// //             //             <div className="font-semibold">{s.name || s.email || s.id}</div>
// //             //             <div className="text-xs text-white/50">{s.email || ""} · {s.mobile || ""}</div>
// //             //         </div>
// //             //         <div className="text-xs text-white/40">{s.created_at ? new Date(s.created_at).toLocaleString("en-IN") : ""}</div>
// //             //     </summary>
// //             //     <pre className="px-4 pb-4 text-xs text-white/70 overflow-auto">{JSON.stringify(s, null, 2)}</pre>
// //             // </details>
// //             <div
// //               key={s.id || i}
// //               className="goi-card rounded-2xl p-6 border border-white/10 hover:border-brand-cyan/40 transition-all"
// //             >
...
// //                 <div className="goi-card p-4 rounded-xl bg-white/5">
// //                   <div className="text-xs text-white/50 uppercase">
// //                     Booking Type
// //                   </div>
// //                   <div className="font-semibold mt-1">{s.booking_type}</div>
// //                 </div>

// //                 <div className="goi-card p-4 rounded-xl bg-white/5">
// //                   <div className="text-xs text-white/50 uppercase">Branch</div>
// //                   <div className="font-semibold mt-1">{s.branch}</div>
// //                 </div>
...
// //                     Preferred Date
// //                   </div>
// //                   <div className="font-semibold mt-1">{s.preferred_date}</div>
// //                 </div>
...
// //                     Preferred Time
// //                   </div>
// //                   <div className="font-semibold mt-1">{s.preferred_time}</div>
// //                 </div>

// //                 <div className="goi-card p-4 rounded-xl bg-white/5">
// //                   <div className="text-xs text-white/50 uppercase">Guests</div>
// //                   <div className="font-semibold mt-1">{s.guests}</div>
// //                 </div>
// //               </div>
...
// //                 <a href={`tel:${s.mobile}`} className="goi-btn-outline">
// //                   📞 Call
// //                 </a>

// //                 <a
// //                   href={`https://wa.me/${s.mobile}`}
// //                   target="_blank"
// //                   rel="noreferrer"
...
//   //     );
//   //     try {
//   //       await adminUpdate(kind, item.id, { status: newStatus });
